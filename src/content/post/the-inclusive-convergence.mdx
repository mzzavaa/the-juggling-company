...
<Takeaways color="change" items={[
  ...
  "A change programme that treats outer-orbit departments as slow or resistant misreads the geometry. Everyone is reaching toward the same center. The outer-orbit participant has as much right to the convergence as the one who arrived first. The entry requirement is only: reach in."
]} />
