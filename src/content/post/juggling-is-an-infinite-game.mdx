...
The loop in a passing pattern runs through both pairs of hands. The balls or clubs are not in one person's possession - they travel along the continuous arc from one side to the other and back. The infinite game is not a solo performance. It is a shared pattern, sustained by everyone who chooses to keep playing.
