...
This forward-planning, anticipatory orientation is what transforms a reactive responder into a practitioner who is always slightly ahead of the moment.
</Callout>
...
The orienting question is not yet visible in the external world. It is: where is the next ball going to peak?
</Callout>

<Takeaways color="brain" items={[
  "Motor neuroscience has consistently found that brain activity associated with voluntary movement precedes the physical movement by 200-500ms (Libet et al., 1983). The brain throws first. Every visible action is downstream of an earlier internal decision.",
  ...
  "The brain precedes the arc by a measurable interval. Building intentional forward-planning into a change program is the structural version of what the brain does before every throw."
]} />
