...
The infinity pattern in the image is not coincidental. The figure-eight - the loop that crosses itself at the center and returns to where it started - is the visual signature of sustained motion without terminus.
