...
summary: "Every juggling throw is a release. The hand that never opens cannot juggle - it can only hold. The release is not the end of the practice. It is the act that makes the next catch possible."
date: 2026-06-26
...
<StatGrid items={[
  { value: "Released", label: "The capacity continues after release", sub: "What the prop carried in the hand does not disappear when the hand opens. The trajectory continues. What is let go is not destroyed - it travels onward.", color: "change" },
  { value: "Open hand", label: "The posture of the skilled release", sub: "A clean release happens with an open hand, not one jerked away or clenched. The clean release is practiced, not improvised. The hand knows how to open at the right moment.", color: "change" },
...
The club arrives well because the release was clean.
</Callout>
...
<Takeaways color="change" items={[
  ...
  "The capacity and value that existed in what is being released do not go out when it leaves the hand. Identity-linked releases - letting go of processes people built and owned - carry this loss as a real one, not an operational detail.",
  ...
  "Between release and catch is the neutral zone (Bridges, 1991) - the phase where neither old nor new is fully present. This is uncomfortable but productive: old patterns become visible as patterns, and new ones can be tried without full institutional weight. The club in the gap is still in motion."
]} />
