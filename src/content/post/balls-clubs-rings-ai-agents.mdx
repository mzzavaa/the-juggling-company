...
<div style="border-left: 4px solid #6366f1; padding: 0.875rem 1.25rem; margin: 1.75rem 0; background: color-mix(in oklab, #6366f1 6%, transparent); border-radius: 0 8px 8px 0;">
  <p style="margin: 0; font-style: italic; font-size: 1.05rem; line-height: 1.6;">"When you can handle three balls cleanly, you introduce rings into the pattern - not to replace the balls, but because the mix becomes richer."</p>
</div>
